...
Source Database : leek_bbs
Target Host     : localhost:3306
Target Database : leek_bbs
Date: 2020-06-19 11:54:36
*/
...
CREATE TABLE `attention` (
  ...
  `aid` int(11) DEFAULT NULL COMMENT '要关注的用户id',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=16 DEFAULT CHARSET=utf8 COMMENT='关注表';
...
CREATE TABLE `experience` (
  ...
  `user_experience` int(11) DEFAULT '10' COMMENT '最后获得的经验',
  `time` varchar(19) DEFAULT '2020-05-10' COMMENT '最后获取经验的具体时间',
  `total_experience` int(11) DEFAULT '10' COMMENT '总经验',
  `reserve1` varchar(100) DEFAULT NULL COMMENT '预留字段1',
  `reserve2` varchar(100) DEFAULT NULL COMMENT '预留字段2',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=19 DEFAULT CHARSET=utf8 COMMENT='用户经验详细表';
...
CREATE TABLE `friend_group` (
  ...
  `group_name` varchar(21) NOT NULL COMMENT '分组名称',
  `user_id` int(11) DEFAULT NULL COMMENT '分组所属用户',
  PRIMARY KEY (`group_id`)
) ENGINE=InnoDB AUTO_INCREMENT=33 DEFAULT CHARSET=utf8 COMMENT='好友分组表';
...
CREATE TABLE `grade` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(21) DEFAULT NULL COMMENT '等级称号',
  `img` varchar(80) DEFAULT NULL COMMENT '等级图片',
  `g_condition` varchar(11) DEFAULT NULL COMMENT '满足条件',
  `reserve1` varchar(100) DEFAULT NULL COMMENT '预留字段1',
  `reserve2` varchar(100) DEFAULT NULL COMMENT '预留字段2',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8 COMMENT='等级参照表';
...
CREATE TABLE `integral` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `user_id` int(11) DEFAULT NULL COMMENT '用户id',
  `user_integral` int(11) DEFAULT '10' COMMENT '获得的积分',
  `last_time` varchar(19) DEFAULT '2020-05-10' COMMENT '最后获取积分的具体时间',
  `total_integral` int(11) DEFAULT '10' COMMENT '总积分',
  `reserve1` varchar(100) DEFAULT NULL COMMENT '预留字段1',
  `reserve2` varchar(100) DEFAULT NULL COMMENT '预留字段2',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=19 DEFAULT CHARSET=utf8 COMMENT='用户积分详细表';
...
CREATE TABLE `leave_word` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `leave_u_id` int(11) DEFAULT NULL COMMENT '留言者id',
  `leave_name` varchar(21) DEFAULT NULL COMMENT '留言者名称',
  `leave_photo` varchar(80) DEFAULT NULL COMMENT '留言者头像',
  `leave_content` text COMMENT '留言内容',
  `to_u_id` int(11) DEFAULT NULL COMMENT '留言给哪个用户id',
...
CREATE TABLE `notice` (
  ...
  `n_title` varchar(80) DEFAULT NULL COMMENT '公告标题',
  `n_content` text COMMENT '公告内容',
  `n_time` datetime DEFAULT NULL COMMENT '发表时间',
  `n_in_plate_name` varchar(11) DEFAULT NULL COMMENT '公告归属专区',
  `n_uid` int(11) DEFAULT NULL,
  `n_plate_id` int(11) DEFAULT NULL COMMENT '所属板块id',
  PRIMARY KEY (`n_id`)
...
INSERT INTO `notice` VALUES ('2', 'dfgyh', 'cdftvgbnjkml<img src=\"http://localhost/leek_bbs/statics/layui/images/face/37.gif\" alt=\"[色]\">', '2020-06-17 09:27:13', '校园趣事', '1', '3');
...
CREATE TABLE `permission` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `permission_name` varchar(50) DEFAULT NULL COMMENT '资源名称',
  `description` varchar(255) DEFAULT NULL COMMENT '权限描述',
  `url` varchar(100) DEFAULT NULL COMMENT '地址',
  `available` tinyint(1) DEFAULT NULL COMMENT '是否有效(0无效,1有效)',
  PRIMARY KEY (`id`)
...
CREATE TABLE `plate` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `plate_name` varchar(11) DEFAULT NULL COMMENT '板块名称',
  `plate_photo` varchar(80) DEFAULT NULL COMMENT '板块图片',
  `theme` int(11) DEFAULT '0' COMMENT '板块主题数',
  `posts` int(11) DEFAULT '0' COMMENT '板块帖子数',
  `collect_total` varchar(11) DEFAULT '0' COMMENT '板块被收藏数',
  `plate_vest` varchar(13) DEFAULT NULL COMMENT '板块归属区',
  `reserve1` varchar(100) DEFAULT NULL COMMENT '板块地址',
  `reserve2` varchar(100) DEFAULT NULL COMMENT '预留字段2',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=16 DEFAULT CHARSET=utf8 COMMENT='板块表';

-- ----------------------------
-- Records of plate
-- ----------------------------
INSERT INTO `plate` VALUES ('1', '学院专区', 'common_2_icon.png', '4', '3', '325', '校园专区', '校园各学院的交流讨论', null);
INSERT INTO `plate` VALUES ('2', '社团专区', 'common_37_icon.png', '3', '0', '325', '校园专区', '校园个社团的讨论专区', null);
INSERT INTO `plate` VALUES ('3', '校园趣事', 'common_38_icon.png', '3', '5', '325', '校园专区', '校园的各种趣事讨论区', null);
INSERT INTO `plate` VALUES ('4', '游戏交流', 'common_43_icon.png', '13', '34', '325', '交流与讨论', '游戏交流的圣地', null);
INSERT INTO `plate` VALUES ('5', '告白墙', 'common_49_icon.png', '2', '0', '325', '交流与讨论', '各兄弟姐妹的交往圣地', null);
...
CREATE TABLE `post` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `title` varchar(50) DEFAULT NULL COMMENT '帖子主题',
  `content` text COMMENT '帖子内容',
  `user_id` int(11) DEFAULT NULL COMMENT '发帖者用户id',
  `browse_count` int(11) unsigned DEFAULT '0' COMMENT '帖子被查看数',
  `reply_count` int(11) unsigned DEFAULT '0' COMMENT '帖子回复数',
  `publish_time` datetime DEFAULT NULL COMMENT '帖子发表时间',
  `first_post` tinyint(1) DEFAULT '0' COMMENT '是否新人帖(0.false,1.true)',
  `post_status` char(1) DEFAULT '6' COMMENT '帖子状态(0违规,1正常,2置顶,3推荐,4精华,5优秀,6未审核)',
  `post_heat` int(11) unsigned DEFAULT '0' COMMENT '帖子热度(数量)',
  `share_count` int(11) unsigned DEFAULT '0' COMMENT '帖子分享次数',
  `post_grade` varchar(11) DEFAULT '1' COMMENT '帖子评分数',
  `post_collect` varchar(11) DEFAULT '1' COMMENT '帖子被收藏数',
  `post_top` varchar(11) DEFAULT '1' COMMENT '帖子被顶人数',
  `post_tread` varchar(11) DEFAULT '1' COMMENT '帖子被踩人数',
  `post_author` varchar(20) DEFAULT NULL COMMENT '帖子作者',
  `plate_id` int(11) DEFAULT NULL COMMENT '帖子所在板块',
  `last_reply` varchar(11) DEFAULT NULL COMMENT '最后回复者',
  `last_reply_time` datetime DEFAULT NULL COMMENT '最后回复时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=32 DEFAULT CHARSET=utf8 COMMENT='帖子表';
...
CREATE TABLE `post_details` (
  ...
  `pd_uid` int(11) DEFAULT NULL COMMENT '回复此帖子的用户id',
  `post_id` int(11) DEFAULT NULL COMMENT '帖子主题id',
  `pd_content` text COMMENT '帖子回复内容',
  `seat` varchar(6) DEFAULT NULL COMMENT '位子(沙发,椅子,凳子,地毯,凉席,报纸,地板,地下室,下水道)',
  `reply_time` datetime DEFAULT NULL COMMENT '帖子回复时间',
  `isLook` char(1) DEFAULT '0' COMMENT '是否已查看',
  PRIMARY KEY (`pid`)
) ENGINE=InnoDB AUTO_INCREMENT=59 DEFAULT CHARSET=utf8 COMMENT='帖子回复表';
...
CREATE TABLE `post_operation` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `postId` int(11) DEFAULT NULL COMMENT '主题id',
  `uid` int(11) DEFAULT NULL COMMENT '用户id',
  `isCompletion` tinyint(1) DEFAULT '1' COMMENT '是否已做操作(0.false,1.true)',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=17 DEFAULT CHARSET=utf8 COMMENT='用户主题操作表';
...
CREATE TABLE `post_report` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) DEFAULT NULL COMMENT '用户id',
  `pid` int(11) DEFAULT NULL COMMENT '主题或帖子id',
  `r_type` varchar(11) DEFAULT NULL COMMENT '举报类型',
  `r_content` varchar(255) DEFAULT NULL COMMENT '内容描述',
  `rp_type` char(1) DEFAULT '1' COMMENT '1.主题2.帖子',
  `r_time` datetime DEFAULT NULL COMMENT '举报时间',
  `r_status` char(1) DEFAULT '0' COMMENT '处理状态(0未处理,1已处理)',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=20 DEFAULT CHARSET=utf8 COMMENT='帖子举报表';
...
CREATE TABLE `post_share` (
  ...
  `plate_name` varchar(11) DEFAULT NULL COMMENT '帖子所在板块',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=18 DEFAULT CHARSET=utf8 COMMENT='用户分享表';
...
CREATE TABLE `sign` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `user_id` int(11) DEFAULT NULL COMMENT '用户id',
  `continuous_days` varchar(19) DEFAULT '0' COMMENT '用户连续签到的天数',
  `total_days` int(11) DEFAULT '0' COMMENT '用户签到总天数',
  `month_days` int(11) DEFAULT '0' COMMENT '月签到天数',
  `last_sign_time` datetime DEFAULT '2020-05-10 12:35:37' COMMENT '签到时间',
  `last_award` varchar(11) DEFAULT '0' COMMENT '最后签到奖励',
  `sign_status` char(1) DEFAULT '1' COMMENT '签到状态''0未签到,1已签到''',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=19 DEFAULT CHARSET=utf8 COMMENT='用户签到详细表';
...
CREATE TABLE `sys_log` (
  ...
  `username` varchar(50) DEFAULT NULL COMMENT '操作者',
  `operation` varchar(50) DEFAULT NULL COMMENT '操作',
  `method` varchar(100) DEFAULT NULL COMMENT '执行方法',
  `url` varchar(80) DEFAULT NULL COMMENT '请求地址',
  `ip` varchar(64) DEFAULT NULL COMMENT 'ip',
  `create_time` datetime NOT NULL COMMENT '操作时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=126 DEFAULT CHARSET=utf8 COMMENT='系统日志表';
...
CREATE TABLE `sys_warn` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) DEFAULT '0' COMMENT '通知者id(0代表给所有人发送提醒通知)',
  `title` varchar(80) DEFAULT NULL COMMENT '标题',
  `content` varchar(255) DEFAULT NULL COMMENT '通知内容',
  `w_time` datetime DEFAULT NULL COMMENT '通知时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=55 DEFAULT CHARSET=utf8 COMMENT='系统提醒表';
...
CREATE TABLE `u_collect` (
  ...
  `all_id` int(11) DEFAULT NULL COMMENT '可以是帖子id,也可以是板块id,也可以是日志id',
  `title` varchar(50) DEFAULT NULL COMMENT '标题',
  `source_plate` varchar(11) DEFAULT NULL COMMENT '来源板块',
  `collect_time` varchar(19) DEFAULT NULL COMMENT '收藏时间',
  `type` char(1) DEFAULT NULL COMMENT '1.帖子,2.板块,3.日志',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=21 DEFAULT CHARSET=utf8 COMMENT='用户所有收藏表';
...
CREATE TABLE `u_log` (
  ...
  `u_log_time` datetime DEFAULT NULL COMMENT '日志时间',
  `reserve1` varchar(100) DEFAULT NULL COMMENT '预留字段1',
  PRIMARY KEY (`log_id`)
...
CREATE TABLE `user` (
  ...
  `salt` varchar(80) DEFAULT NULL COMMENT '加密盐',
  `another_name` varchar(21) DEFAULT NULL COMMENT '别名',
  `age` int(3) DEFAULT NULL COMMENT '年龄',
  `sex` char(2) DEFAULT NULL COMMENT '性别',
  `email` varchar(21) DEFAULT NULL COMMENT '邮箱',
  `phone` bigint(11) DEFAULT NULL COMMENT '手机号码',
  `picture` varchar(100) DEFAULT 'statics/images/01_small.gif' COMMENT '用户头像',
  `personalized_sign` varchar(255) DEFAULT '填写个性签名...' COMMENT '个性签名',
  `register_time` datetime DEFAULT NULL COMMENT '注册时间',
  `register_ip` varchar(17) DEFAULT NULL COMMENT '注册ip',
  `last_login_time` datetime DEFAULT NULL COMMENT '最后登录时间',
  `last_login_ip` varchar(17) DEFAULT NULL COMMENT '最后登录ip',
  `address` varchar(21) DEFAULT NULL COMMENT '居住地址',
  `profession` varchar(18) DEFAULT NULL COMMENT '职业',
  `online_status` char(1) DEFAULT NULL COMMENT '在线状态(0不在线,1在线)',
  `user_status` char(1) DEFAULT '1' COMMENT '用户状态(0禁止,1正常)',
  PRIMARY KEY (`id`)
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES ('1', 'gone165', '72576bb713c723c6b0a424c66998ca63', 'JVflfefrwl==', '001-1号', null, '男', '2247436297@qq.com', '15279515773', 'statics/images/u1.png', '天下武功,为快不破', '2020-03-14 21:29:00', '127.0.0.1', '2020-06-04 10:26:56', '223.84.180.123', '计算机专业', '江西宜春', '0', '1');
INSERT INTO `user` VALUES ('2', 'hoama1234', '10ed3278a8144cf6e1f9155cc65a11cb', 'HlfliarEhJ==', '002-2号', null, '女', '2247436297@qq.com', '15279515773', 'statics/images/u2.jpg', '天下武功,为快不破', '2020-03-14 21:55:00', '127.0.0.1', null, null, '计算机专业', '江西宜春', '0', '1');
INSERT INTO `user` VALUES ('3', 'aini00', '3f625c5622e817b31284fbb7ae0b45b6', 'JJfGwe=liV==', '迷失者', null, '男', '2217963603@qq.co', '15279515773', 'statics/images/u4.jpg', '天下武功,为快不破', '2020-03-14 22:01:00', '127.0.0.1', '2020-06-19 09:12:31', '127.0.0.1', '计算机专业', '江西宜春', '0', '1');
INSERT INTO `user` VALUES ('4', 'admin', '10ed3278a8144cf6e1f9155cc65a11cb', 'HlfliarEhJ==', '测试者', null, '男', '2247436297@qq.com', '15279515773', 'statics/images/toux2.jpg', '天下武功,为快不破', '2020-03-15 13:38:00', '127.0.0.1', '2020-06-18 23:22:26', '127.0.0.1', '计算机专业', '江西宜春', '0', '1');
INSERT INTO `user` VALUES ('5', 'zsan', '10ed3278a8144cf6e1f9155cc65a11cb', 'HlfliarEhJ==', '005-5号', null, '男', '2247436297@qq.com', '13479129250', 'statics/images/01_small.gif', '天下武功,为快不破', '2020-04-30 15:30:00', '127.0.0.1', null, null, '计算机专业', '江西宜春', '0', '1');
INSERT INTO `user` VALUES ('6', 'lis', '10ed3278a8144cf6e1f9155cc65a11cb', 'HlfliarEhJ==', '006-6号', null, '男', '2247436297@qq.com', '13479129250', 'statics/images/u3.jpg', '天下武功,为快不破', '2020-04-30 15:30:00', '127.0.0.1', '2020-06-07 11:49:39', '127.0.0.1', '计算机专业', '江西宜春', '0', '1');
INSERT INTO `user` VALUES ('7', 'wang', '10ed3278a8144cf6e1f9155cc65a11cb', 'HlfliarEhJ==', '007-7号', null, '男', '2247436297@qq.com', '18347920132', 'statics/images/u4.jpg', '天下武功,为快不破', '2020-04-30 15:30:00', '127.0.01', null, null, '计算机专业', '江西宜春', '0', '1');
INSERT INTO `user` VALUES ('8', 'zhaoliu', '10ed3278a8144cf6e1f9155cc65a11cb', 'HlfliarEhJ==', '008-8号', null, '男', '2247436297@qq.com', '18024545382', 'statics/images/u5.jpg', '天下武功,为快不破', '2020-04-30 15:30:00', '127.0.0.1', null, null, '计算机专业', '江西宜春', '0', '1');
INSERT INTO `user` VALUES ('9', '2309474', '56df00fb29d2df14c63e35cc24ce020b', 'GwffrEf=HG==', '也许!', null, null, '2569678654@qq.com', null, 'statics/images/01_small.gif', null, '2020-05-11 21:59:01', '127.0.0.1', null, null, null, null, null, '1');
...
CREATE TABLE `user_friend` (
  ...
  `group_id` int(11) DEFAULT NULL COMMENT '分组名称',
  `status` char(1) DEFAULT '0' COMMENT '好友申请状态(0.申请,1.同意,2.拒绝,3.不显示)',
  `apply_time` datetime DEFAULT NULL COMMENT '申请时间',
  `postscript` varchar(50) DEFAULT NULL COMMENT '申请附言',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=35 DEFAULT CHARSET=utf8 COMMENT='用户好友表';
